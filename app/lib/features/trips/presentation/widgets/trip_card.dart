    ...
    return Card(
      ...
      child: InkWell(
        ...
        child: Row(
          ...
          children: [
            ColoredBox(color: tripColor, child: const SizedBox(width: 10)),
            Expanded(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      runSpacing: 10,
                      children: [
                        _MetaPill(label: '${trip.days.length} 天', color: tripColor),
                        _MetaPill(label: '${trip.stopCount} 個停靠點', color: tripColor),
                        _MetaPill(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: tintColor(color, amount: 0.88),
        borderRadius: BorderRadius.circular(999),
      ),
      child: Text(
        label,
        style: TextStyle(
          color: shadeColor(color, amount: 0.34),
